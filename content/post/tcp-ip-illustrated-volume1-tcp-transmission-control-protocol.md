---
title: "TCP/IP 详解(卷一) TCP：传输控制协议"
date: 2018-05-15 15:43:47
udpated: 2018-05-15 15:43:47
comments: true
mathjax: true
categories:
 - Study
...
TCP数据被封装在一个IP数据报中，IP首部(20字节) + TCP首部(20字节) + TCP数据。

TCP首部的数据格式。如果不计任选字段，它通常是20个字节。

![](/images/tcp-ip/tcp-header.jpg)
